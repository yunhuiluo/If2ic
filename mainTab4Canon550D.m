...
%% options
opt.Nc=2;
opt.datasetSelected={'Cubep','GehlerShi','gehlershi_and_cubep',...
    'canon5D_gehlershi','canonEOS550D_cubep'};
opt.iDatSelected=5;
...
for i=1:size(FeatSetNames,2)
    for j=1:size(featNames,2)
        try
            ...
            save2XlsMethodPerf(resultLsq{i,j},fullfile('results','tab1CanonEOS550D.xlsx'));
        catch
        end
    end
end
...
for i=1:8
    ...
    save2XlsMethodPerf(resultUnitary,fullfile('results','tab1CanonEOS550D.xlsx'));
end
